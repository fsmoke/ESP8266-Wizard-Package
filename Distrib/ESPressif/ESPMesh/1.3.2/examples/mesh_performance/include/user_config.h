...
static const uint8_t MESH_GROUP_ID[6] = {0x18,0xfe,0x34,0x00,0x00,0x51};  /*MESH_GROUP_ID & MESH_SSID_PREFIX REPRESENTS ONE MESH NETWORK*/
...
#define MESH_AUTH            AUTH_OPEN  /*AUTH_MODE OF SOFTAP FOR EACH MESH NODE*/
